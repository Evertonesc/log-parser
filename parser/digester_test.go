...
func TestAddPlayerHandler_Handle(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args: args{
				logLine: "  0:25 ClientUserinfoChanged: 2 n\\Dono da Bola\\t\\0\\model\\sarge/krusade\\hmodel\\sarge/krusade\\g_redteam\\\\g_blueteam\\\\c1\\5\\c2\\5\\hc\\95\\w\\0\\l\\0\\tt\\0\\tl\\0",
				match: func() *match.Match {
					m := match.NewMatch()
					m.InProgress = true
		...
		},
		{
			name: "should successfully parse a client user info changed log entry and update the match data with a new player",
			args: args{
				logLine: "981:06 ClientUserinfoChanged: 2 n\\Isgalamido\\t\\3\\model\\sarge/krusade\\hmodel\\sarge/krusade\\g_redteam\\\\g_blueteam\\\\c1\\5\\c2\\5\\hc\\95\\w\\0\\l\\0\\tt\\0\\tl\\0",
				match: func() *match.Match {
					m := match.NewMatch()
					m.InProgress = true
...
func TestKillDetailsHandler_Handle(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			name: "should successfully parse the kill log entry and add its information to the match",
			args: args{
				logLine: "  6:59 Kill: 5 3 7: Assasinu Credi killed Oootsimo by MOD_ROCKET_SPLASH",
				match: func() *match.Match {
					return &match.Match{
						TotalKills: 5,
						Players:    []string{"Assasinu Credi", "Oootsimo"},
						Kills: map[string]int{
							"Assasinu Credi": 3,
							"Oootsimo":       2,
						},
